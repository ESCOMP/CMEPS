module esmFldsExchange_nems_frac_mod
  ...
  public :: esmFldsExchange_nems_frac
...
contains
  ...
  subroutine esmFldsExchange_nems_frac(gcomp, phase, rc)
    ...
    use esmflds               , only : mapbilnr, mapconsf, mappatch, mapfcopy
    ...
    character(len=*) , parameter   :: subname='(esmFldsExchange_nems_frac)'
    !--------------------------------------
    ...
    call addmap(fldListFr(compice)%flds, 'Faii_taux', compatm, mapconsf, 'ifrac', 'unset')
    ...
    call addmap(fldListFr(compice)%flds, 'Faii_tauy', compatm, mapconsf, 'ifrac', 'unset')
    ...
    call addmap(fldListFr(compice)%flds, 'Faii_lat', compatm, mapconsf, 'ifrac', 'unset')
    ...
    call addmap(fldListFr(compice)%flds, 'Faii_sen', compatm, mapconsf, 'ifrac', 'unset')
    ...
    call addmap(fldListFr(compice)%flds, 'Faii_lwup', compatm, mapconsf, 'ifrac', 'unset')
    ...
    call addmap(fldListFr(compice)%flds, 'Faii_evap', compatm, mapconsf, 'ifrac', 'unset')
    ...
    call addmap(fldListFr(compice)%flds, 'sea_ice_surface_temperature', compatm, mapconsf, 'ifrac')
    ...
    call addmap(fldListFr(compocn)%flds, 'So_t', compatm, mapconsf, 'none' , 'unset')
    ...
    call addmap(fldListFr(compice)%flds, 'Si_vice', compatm, mapconsf, 'ifrac', 'unset')
    ...
    call addmap(fldListFr(compice)%flds, 'Si_vsno', compatm, mapconsf, 'ifrac', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Faxa_lwnet', compocn, mapconsf, 'one'  , 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Faxa_swvdr', compocn, mapconsf, 'one', 'unset')
    call addmap(fldListFr(compatm)%flds, 'Faxa_swvdf', compocn, mapconsf, 'one', 'unset')
    call addmap(fldListFr(compatm)%flds, 'Faxa_swndr', compocn, mapconsf, 'one', 'unset')
    call addmap(fldListFr(compatm)%flds, 'Faxa_swndf', compocn, mapconsf, 'one', 'unset')
    ...
    call addmap(fldListFr(compice)%flds, 'mean_net_sw_vis_dir_flx', compocn, mapfcopy, 'unset', 'unset')
    call addmap(fldListFr(compice)%flds, 'mean_net_sw_vis_dif_flx', compocn, mapfcopy, 'unset', 'unset')
    call addmap(fldListFr(compice)%flds, 'mean_net_sw_ir_dir_flx' , compocn, mapfcopy, 'unset', 'unset')
    call addmap(fldListFr(compice)%flds, 'mean_net_sw_ir_dif_flx' , compocn, mapfcopy, 'unset', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Faxa_rain', compocn, mapconsf, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Faxa_snow', compocn, mapconsf, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Faxa_sen', compocn, mapconsf, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Faxa_lat' , compocn, mapconsf, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Sa_pslv', compice, mapbilnr, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Faxa_lwdn', compice, mapconsf, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Faxa_swndr', compice, mapconsf, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Faxa_swvdr', compice, mapconsf, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Faxa_swndf', compice, mapconsf, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Faxa_swvdf', compice, mapconsf, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Faxa_rain', compice, mapconsf, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Faxa_snow', compice, mapconsf, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Sa_u', compice, mappatch, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Sa_v', compice, mappatch, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Sa_z', compice, mapbilnr, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Sa_pbot', compice, mapbilnr, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Sa_tbot', compice, mapbilnr, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Sa_ptem', compice, mapbilnr, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Sa_dens', compice, mapbilnr, 'one', 'unset')
    ...
    call addmap(fldListFr(compatm)%flds, 'Sa_shum', compice, mapbilnr, 'one', 'unset')
  ...
  end subroutine esmFldsExchange_nems_frac

end module esmFldsExchange_nems_frac_mod
